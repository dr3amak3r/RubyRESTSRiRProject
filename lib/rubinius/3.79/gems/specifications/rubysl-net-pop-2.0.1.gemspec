# -*- encoding: utf-8 -*-
# stub: rubysl-net-pop 2.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-net-pop".freeze
  s.version = "2.0.1"
  ...
  s.date = "2013-09-29"
  s.description = "Ruby standard library pop.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-net-pop".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library pop.".freeze
