# -*- encoding: utf-8 -*-
# stub: rubysl-enumerator 2.0.0 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-enumerator".freeze
  s.version = "2.0.0"
  ...
  s.date = "2013-09-21"
  s.description = "Ruby standard library enumerator stub.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-enumerator".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library enumerator stub.".freeze
