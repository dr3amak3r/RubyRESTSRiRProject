# -*- encoding: utf-8 -*-
# stub: rubysl-profiler 2.1 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-profiler".freeze
  s.version = "2.1"
  ...
  s.date = "2016-05-08"
  s.description = "Ruby standard library profiler.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-profiler".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library profiler.".freeze
