# -*- encoding: utf-8 -*-
# stub: rubysl-time 2.0.3 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-time".freeze
  s.version = "2.0.3"
  ...
  s.date = "2013-10-08"
  s.description = "Ruby standard library time.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-time".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library time.".freeze
