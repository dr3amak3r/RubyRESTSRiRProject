# -*- encoding: utf-8 -*-
# stub: rubysl-cgi-session 2.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-cgi-session".freeze
  s.version = "2.1.0"
  ...
  s.date = "2015-11-27"
  s.description = "Ruby standard library cgi-session.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-cgi-session".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library cgi-session.".freeze
