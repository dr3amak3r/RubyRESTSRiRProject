# -*- encoding: utf-8 -*-
# stub: rubysl-drb 2.0.1 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-drb".freeze
  s.version = "2.0.1"
  ...
  s.date = "2013-10-02"
  s.description = "Ruby standard library drb.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-drb".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library drb.".freeze
