# -*- encoding: utf-8 -*-
# stub: rubysl-etc 2.0.3 ruby lib
# stub: lib/rubysl/etc/extconf.rb

Gem::Specification.new do |s|
  s.name = "rubysl-etc".freeze
  s.version = "2.0.3"
  ...
  s.date = "2013-10-05"
  s.description = "Ruby standard library etc.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.extensions = ["lib/rubysl/etc/extconf.rb".freeze]
  s.files = ["lib/rubysl/etc/extconf.rb".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-etc".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library etc.".freeze
