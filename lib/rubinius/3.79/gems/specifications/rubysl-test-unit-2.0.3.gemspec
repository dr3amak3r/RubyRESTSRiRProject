# -*- encoding: utf-8 -*-
# stub: rubysl-test-unit 2.0.3 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-test-unit".freeze
  s.version = "2.0.3"
  ...
  s.date = "2013-11-25"
  s.description = "Ruby standard library unit.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-test-unit".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library unit.".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<minitest>.freeze, ["~> 4.7"])
