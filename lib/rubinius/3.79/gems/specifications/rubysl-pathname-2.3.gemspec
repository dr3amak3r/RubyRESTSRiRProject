# -*- encoding: utf-8 -*-
# stub: rubysl-pathname 2.3 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-pathname".freeze
  s.version = "2.3"
  ...
  s.date = "2016-02-19"
  s.description = "Ruby standard library pathname.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-pathname".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library pathname.".freeze
