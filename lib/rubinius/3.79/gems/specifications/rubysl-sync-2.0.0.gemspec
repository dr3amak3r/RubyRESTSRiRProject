# -*- encoding: utf-8 -*-
# stub: rubysl-sync 2.0.0 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-sync".freeze
  s.version = "2.0.0"
  ...
  s.date = "2013-11-02"
  s.description = "Ruby standard library sync.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-sync".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library sync.".freeze
