# -*- encoding: utf-8 -*-
# stub: rubysl-rexml 2.0.4 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-rexml".freeze
  s.version = "2.0.4"
  ...
  s.date = "2014-11-18"
  s.description = "Ruby standard library rexml.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-rexml".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library rexml.".freeze
