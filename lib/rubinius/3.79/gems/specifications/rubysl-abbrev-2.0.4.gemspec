# -*- encoding: utf-8 -*-
# stub: rubysl-abbrev 2.0.4 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-abbrev".freeze
  s.version = "2.0.4"
  ...
  s.date = "2013-11-13"
  s.description = "Ruby standard library abbrev.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-abbrev".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library abbrev.".freeze
