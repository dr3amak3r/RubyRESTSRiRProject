# -*- encoding: utf-8 -*-
# stub: rubysl-date 2.0.9 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-date".freeze
  s.version = "2.0.9"
  ...
  s.date = "2015-01-24"
  s.description = "Ruby standard library date.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-date".freeze
  s.licenses = ["BSD".freeze]
  s.required_ruby_version = Gem::Requirement.new("~> 2.0".freeze)
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library date.".freeze
