# -*- encoding: utf-8 -*-
# stub: rubysl-e2mmap 2.0.0 ruby lib

Gem::Specification.new do |s|
  s.name = "rubysl-e2mmap".freeze
  s.version = "2.0.0"
  ...
  s.date = "2013-09-08"
  s.description = "Ruby standard library e2mmap.".freeze
  s.email = ["brixen@gmail.com".freeze]
  s.homepage = "https://github.com/rubysl/rubysl-e2mmap".freeze
  s.licenses = ["BSD".freeze]
  s.rubygems_version = "2.6.6".freeze
  s.summary = "Ruby standard library e2mmap.".freeze
